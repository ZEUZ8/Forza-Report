  ...
  return (
    <div className="grid max-h-[100%]">
      <div className="grid  xl:grid-cols-2 gap-4 ">
        <div className="grid max-lg:grid-rows-1 grid-rows-2 gap-4 dark:text-white pt-[.3rem]">
            ...
            <div className="col-span-12 lg:col-span-4  ">
              <div className="grid sm:max-lg:grid-cols-6  gap-5">
                <div className="sm:max-lg:col-span-2  grid max-sm:grid-cols-2 lg:grid-cols-2  gap-5  text-start ">
                  <div className="rounded-md shadow-special dark:shadow-special2 grid gap-3 p-3 font-medium">
                    <p>FOC</p>
                    <p>09</p>
                  </div>
                  <div className="rounded-md shadow-special dark:shadow-special2 grid gap-3 p-3 font-medium">
                ...
                <div className=" sm:max-lg:col-span-4  grid shadow-special dark:shadow-special2 rounded-lg ">
